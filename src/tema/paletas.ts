...
export const paletas: Record<PaletaId, Paleta> = {
  bloco: {
    ...
    tokens: {
      ...
      toastInk: '#ffffff',
      toastCheck: '#7fd8a4',
      accentShadow: 'rgba(43,42,102,.35)',
      hero: '#2b2a66',
      onHero: '#ffffff',
      onHeroSoft: 'rgba(255,255,255,.64)',
      heroLine: 'rgba(255,255,255,.3)',
      atencao: ATENCAO_CLARO,
    },
  },
  marinho: {
  ...
  ameixa: {
    ...
    tokens: {
      ...
      toastInk: '#ffffff',
      toastCheck: '#7fd8a4',
      accentShadow: 'rgba(74,29,82,.33)',
      hero: '#4a1d52',
      onHero: '#ffffff',
      onHeroSoft: 'rgba(255,255,255,.66)',
      heroLine: 'rgba(255,255,255,.3)',
      atencao: ATENCAO_CLARO,
    },
  },
  terracota: {
    ...
    tokens: {
      ...
      toastInk: '#ffffff',
      toastCheck: '#7fd8a4',
      accentShadow: 'rgba(184,67,31,.32)',
      hero: '#b8431f',
      onHero: '#ffffff',
      onHeroSoft: 'rgba(255,255,255,.7)',
      heroLine: 'rgba(255,255,255,.32)',
      atencao: ATENCAO_CLARO,
    },
  },
  lima: {
    ...
    tokens: {
      ...
      toastInk: '#d3f26b',
      toastCheck: '#d3f26b',
      accentShadow: 'rgba(20,21,15,.3)',
      hero: '#d3f26b',
      onHero: '#14150f',
      onHeroSoft: 'rgba(20,21,15,.62)',
      heroLine: 'rgba(20,21,15,.18)',
      atencao: '#a06a12',
    },
  },
  verde: {
  ...
  papel: {
    ...
    tokens: {
      ...
      toastInk: '#ffffff',
      toastCheck: '#7fd8a4',
      accentShadow: 'rgba(122,74,56,.35)',
      hero: '#17140f',
      onHero: '#ffffff',
      onHeroSoft: 'rgba(255,255,255,.6)',
      heroLine: 'rgba(255,255,255,.26)',
      atencao: ATENCAO_CLARO,
    },
  },
  gelo: {
    ...
    tokens: {
      ...
      toastInk: '#ffffff',
      toastCheck: '#5eead4',
      accentShadow: 'rgba(15,118,110,.32)',
      hero: '#0f766e',
      onHero: '#ffffff',
      onHeroSoft: 'rgba(255,255,255,.66)',
      heroLine: 'rgba(255,255,255,.3)',
  ...
  meianoite: {
    ...
    tokens: {
      ...
      toastInk: '#0a0f16',
      toastCheck: '#0f7a43',
      accentShadow: 'rgba(127,168,255,.28)',
      hero: '#142033',
      onHero: '#eaf0f8',
      onHeroSoft: 'rgba(234,240,248,.62)',
      heroLine: 'rgba(234,240,248,.16)',
      atencao: ATENCAO_ESCURO,
    },
  },
  ameixaNoite: {
    ...
    tokens: {
      ...
      toastInk: '#12091b',
      toastCheck: '#0f7a43',
      accentShadow: 'rgba(201,166,247,.28)',
      hero: '#2a1740',
      onHero: '#f2ecf7',
      onHeroSoft: 'rgba(242,236,247,.62)',
      heroLine: 'rgba(242,236,247,.16)',
      atencao: ATENCAO_ESCURO,
    },
  },
  floresta: {
    ...
    tokens: {
      ...
      toastInk: '#062018',
      toastCheck: '#0f7a43',
      accentShadow: 'rgba(94,234,212,.26)',
      hero: '#0f2b21',
      onHero: '#e9f2ec',
      onHeroSoft: 'rgba(233,242,236,.62)',
      heroLine: 'rgba(233,242,236,.16)',
      atencao: ATENCAO_ESCURO,
    },
  },
  oled: {
    ...
    tokens: {
      ...
      toastInk: '#14150f',
      toastCheck: '#14150f',
      accentShadow: 'rgba(211,242,107,.26)',
      hero: '#d3f26b',
      onHero: '#14150f',
      onHeroSoft: 'rgba(20,21,15,.62)',
      heroLine: 'rgba(20,21,15,.18)',
  ...
  grafite: {
    ...
    tokens: {
      ...
      toastInk: '#14161a',
      toastCheck: '#0f7a43',
      accentShadow: 'rgba(224,164,92,.3)',
      hero: '#191c21',
      onHero: '#f1f3f6',
      onHeroSoft: 'rgba(241,243,246,.6)',
      heroLine: 'rgba(241,243,246,.16)',
      atencao: ATENCAO_ESCURO,
    },
  },
};
