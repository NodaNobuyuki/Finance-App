...
export const contas: Conta[] = [
  { id: 'carteira', nome: 'Carteira', tipo: 'carteira', saldoInicialCentavos: 59320, cor: hex('#8a6d3b') },
  { id: 'corrente', nome: 'Conta corrente', tipo: 'corrente', saldoInicialCentavos: 270575, cor: hex('#2f6f8f') },
  { id: 'cartao', nome: 'Cartão', tipo: 'cartao', saldoInicialCentavos: -62090, cor: token('down') },
  { id: 'poupanca', nome: 'Poupança', tipo: 'poupanca', saldoInicialCentavos: 462000, cor: token('up') },
];
...
export const metas: Meta[] = [
  {
    id: 'chile', nome: 'Viagem para o Chile',
    alvoCentavos: 800000, guardadoInicialCentavos: 320000,
    prazo: 'faltam 134 dias · 15 dez 2026',
    cor: hex('#2f6f8f'), icone: 'M2 12h20M12 2c3 3 3 17 0 20M12 2c-3 3-3 17 0 20',
  },
  {
    id: 'reserva', nome: 'Reserva de emergência',
    alvoCentavos: 1200000, guardadoInicialCentavos: 640000,
    prazo: 'faltam 11 meses · jun 2027',
    cor: token('up'), icone: 'M12 3l8 3v6c0 5-3.4 8.2-8 9-4.6-.8-8-4-8-9V6z',
  },
  {
    id: 'note', nome: 'Notebook novo',
    alvoCentavos: 450000, guardadoInicialCentavos: 285000,
    prazo: 'faltam 78 dias · 20 out 2026',
    cor: token('accent'), icone: 'M4 5h16v10H4zM2 19h20M9 19l.6-2h4.8l.6 2',
  },
];

export const desafios: Desafio[] = [
  {
    id: 'reg4', nome: 'Registrar 4 vezes nesta semana', sub: 'a semana fecha domingo', subOff: '',
    alvo: 4, unidade: 'registros', acao: 'Registrar agora', progressoInicial: 0,
    automatico: true, ativoPorPadrao: true, categoriaId: 'salario', economiaCentavos: 0,
  },
  {
    id: 'catg', nome: 'Categorizar tudo do mês', sub: '2 lançamentos sem categoria', subOff: '',
    alvo: 14, unidade: 'lançamentos', acao: 'Revisar 1', progressoInicial: 12,
    ativoPorPadrao: true, categoriaId: 'contas', economiaCentavos: 0,
  },
  {
    id: 'assin', nome: 'Revisar as assinaturas', sub: '3 assinaturas ativas', subOff: '',
    alvo: 3, unidade: 'assinaturas', acao: 'Revisar 1', progressoInicial: 1,
    ativoPorPadrao: true, categoriaId: 'assinaturas', economiaCentavos: 0,
  },
  {
    id: 'delivery', nome: 'Semana sem delivery', sub: 'termina domingo, 9 de agosto',
    subOff: 'opcional · R$ 312 em julho',
    alvo: 7, unidade: 'dias', acao: 'Marcar hoje', progressoInicial: 0,
    ativoPorPadrao: false, categoriaId: 'restaurante', economiaCentavos: 31200,
  },
  {
    id: 'cafe', nome: '5 dias sem café fora', sub: 'termina sexta',
    subOff: 'opcional · R$ 12 por dia',
    alvo: 5, unidade: 'dias', acao: 'Marcar hoje', progressoInicial: 0,
    ativoPorPadrao: false, categoriaId: 'restaurante', economiaCentavos: 6000,
  },
  {
    id: 'uber', nome: 'Semana sem app de transporte', sub: 'termina domingo',
    subOff: 'opcional · R$ 244 em julho',
    alvo: 7, unidade: 'dias', acao: 'Marcar hoje', progressoInicial: 0,
    ativoPorPadrao: false, categoriaId: 'transporte', economiaCentavos: 24400,
  },
];
