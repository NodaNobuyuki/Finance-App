...
export const categorias: Record<string, Categoria> = {
  mercado: {
    id: 'mercado', nome: 'Mercado', tipo: 'despesa', cor: token('up'),
    icone: 'M6 6h15l-1.6 9H7.5zM6 6L5.2 3H2M9.5 20a1 1 0 100-2 1 1 0 000 2M18 20a1 1 0 100-2 1 1 0 000 2',
  },
  restaurante: {
    id: 'restaurante', nome: 'Restaurante', tipo: 'despesa', cor: hex('#c0562b'),
    icone: 'M6 3v7a2 2 0 004 0V3M8 10v11M17 3c-1.4 2-2 4-2 6h4c0-2-.6-4-2-6zM17 9v12',
  },
  transporte: {
    id: 'transporte', nome: 'Transporte', tipo: 'despesa', cor: hex('#2f6f8f'),
    icone: 'M5 13l1.6-4.6A2 2 0 018.5 7h7a2 2 0 011.9 1.4L19 13v5h-3v-2H8v2H5zM7.6 15.4h.01M16.4 15.4h.01',
  },
  casa: {
    id: 'casa', nome: 'Casa', tipo: 'despesa', cor: token('accent'),
    icone: 'M3 10.5L12 3l9 7.5V21H3zM9.5 21v-6h5v6',
  },
  saude: {
    id: 'saude', nome: 'Saúde', tipo: 'despesa', cor: hex('#b03a5b'),
    icone: 'M12 20s-7-4.4-7-9.4A3.6 3.6 0 0112 8a3.6 3.6 0 017 2.6c0 5-7 9.4-7 9.4z',
  },
  lazer: {
    id: 'lazer', nome: 'Lazer', tipo: 'despesa', cor: hex('#6b4e9e'),
    icone: 'M9 18V5l10-2v13M9 18a3 3 0 11-6 0 3 3 0 016 0zM19 16a3 3 0 11-6 0 3 3 0 016 0z',
  },
  educacao: {
    id: 'educacao', nome: 'Educação', tipo: 'despesa', cor: hex('#3c6e5b'),
    icone: 'M4 4h6.5a2 2 0 012 2v14a2 2 0 00-2-2H4zM20 4h-6.5a2 2 0 00-2 2v14a2 2 0 012-2H20z',
  },
  contas: {
    id: 'contas', nome: 'Contas', tipo: 'despesa', cor: hex('#8a6d3b'),
    icone: 'M6 2h9l4 4v16l-3-2-3 2-3-2-3 2zM9 9h6M9 13h6M9 17h4',
  },
  assinaturas: {
    id: 'assinaturas', nome: 'Assinaturas', tipo: 'despesa', cor: hex('#4a5f8a'),
    icone: 'M4 9a5 5 0 015-5h9M18 4l3 3-3 3M20 15a5 5 0 01-5 5H6M6 20l-3-3 3-3',
  },
  salario: {
    id: 'salario', nome: 'Salário', tipo: 'receita', cor: token('up'),
    icone: 'M3 8h15a3 3 0 013 3v6a3 3 0 01-3 3H6a3 3 0 01-3-3zM3 8V7a2 2 0 012-2h11M17 14h.01',
  },
  freela: {
    id: 'freela', nome: 'Freela', tipo: 'receita', cor: hex('#3c6e5b'),
    icone: 'M3 8h18v11H3zM8.5 8V5h7v3M3 13h18',
  },
  presente: {
    id: 'presente', nome: 'Presente', tipo: 'receita', cor: hex('#b03a5b'),
    icone: 'M3 11h18v10H3zM3 7h18v4H3zM12 7v14M12 7S9.6 7 8.6 6s-.4-2.5 1-2.5S12 7 12 7zM12 7s2.4 0 3.4-1 .4-2.5-1-2.5S12 7 12 7z',
  },
  investimento: {
    id: 'investimento', nome: 'Investimento', tipo: 'receita', cor: hex('#2f6f8f'),
...
export const icones = {
  ...
  lampada: 'M9 18h6M10 21h4M12 3a6 6 0 00-3.5 10.9c.5.4.8 1 .8 1.6h5.4c0-.6.3-1.2.8-1.6A6 6 0 0012 3z',
